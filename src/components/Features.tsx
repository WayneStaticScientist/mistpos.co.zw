...
export default function Features() {
  ...
  return (
    <section id="features" className="py-24 px-6 relative overflow-hidden bg-muted/20 dark:bg-slate-950/20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Enterprise tools, <br className="hidden md:block" /> built for scaling businesses
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Explore our comprehensive suite of advanced billing, real-time tracking, and AI-driven operations.
          </motion.p>
        </div>
          ...
          <AnimatePresence mode="popLayout">
            {filteredFeatures.map((feature) => (
              ...
              >
                ...
                <div className={`absolute -inset-px bg-gradient-to-r ${feature.color} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-500 rounded-[2rem] -z-10`} />

                <div>
                  <div className={`w-12 h-12 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6 shadow-lg shadow-primary/10 group-hover:scale-110 transition-transform duration-300`}>
